...
**
** Created: Sun Mar 6 23:17:58 2011
**      by: The Qt Meta Object Compiler version 62 (Qt 4.7.1)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../../../GpsKB-0.1/src/dialogimpl.h"
...
static const char qt_meta_stringdata_DialogImpl[] = {
    "DialogImpl\0\0hesapla()\0DrHesapla()\0"
    "getKayitYolu()\0"
};

const QMetaObject DialogImpl::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_DialogImpl,
...
void *DialogImpl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::AnaPencere"))
        return static_cast< Ui::AnaPencere*>(const_cast< DialogImpl*>(this));
...
int DialogImpl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: hesapla(); break;
        case 1: DrHesapla(); break;
        case 2: getKayitYolu(); break;
        default: ;
        }
        _id -= 3;
    }
